      		...
      		<div class="columns clearfix" id="fadeOut">
				...
				<?php if ( get_post_meta($post->ID, '_playne2_buttontextcustom2', true)) { ?>
					<div class="second-button">
			 			...
			 			<a target="_blank" href="https://play.google.com/store/apps/details?id=com.mygreencar&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"><img alt="Get it on Google Play" src="/wp-content/uploads/2017/12/google-play-badge-300x89.png"/></a>
					</div>
			 	<?php } ?>
