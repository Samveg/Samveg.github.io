...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-108620700-1"></script>
	<script>
      		...
      		<div class="columns clearfix" id="fadeOut">
				...
				<?php if ( get_post_meta($post->ID, '_playne2_buttontextcustom', true)) { ?>
					<div class="first-button">
			 			...
			 			<a target="_blank" href="https://itunes.apple.com/us/app/mygreencar/id963429595?mt=8"><img alt="Download on the App Store" src="<?php echo home_url(); ?>/wp-content/uploads/2017/12/AppStoreBadge-300x90.png"/></a>
					</div>
			 	<?php } ?>
				...
				<?php if ( get_post_meta($post->ID, '_playne2_buttontextcustom2', true)) { ?>
					<div class="second-button">
			 			...
			 			<a target="_blank" href="https://play.google.com/store/apps/details?id=com.mygreencar&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"><img alt="Get it on Google Play" src="<?php echo home_url(); ?>/wp-content/uploads/2017/12/google-play-badge-300x89.png"/></a>
					</div>
			 	<?php } ?>
